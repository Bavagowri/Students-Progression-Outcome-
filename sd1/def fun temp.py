def input_credits():                               #To take inputs and check whether they are integers and in the given range
    ...
    try:
        pass_credits=int(input("Enter your total PASS credits:"))         #To take user input for pass_credits  
        if pass_credits in credits_range:                                 # Checking whether pass_credits value is similar to one of the value in the credits_range list
            defer_credits=int(input("Enter your total DEFER credits:"))   # If the condition is true take input for defer_credits
            if defer_credits in credits_range:                            # Checking whether defer_credits value is similar to one of the value in the credits_range list             
                fail_credits=int(input("Enter your total FAIL credits:")) # If the condition is true take input for fail_credits
                if fail_credits in credits_range:                         # Checking whether fail_credits value is similar to one of the value in the credits_range list
                    total=pass_credits + defer_credits + fail_credits     # To find the total
                    if total!=120:                                        # If total is not equal to 120 then program will prints the message below if condition
                    ...
                    if total==120:                                        # If total is equal to 120 then program will executes the user defined function progress_outcome
                        ...
                        save_input()                                      #To save all input values with its progression outcome
                                           
                else:
                    print("The credits you entered are 'Out of Range'")  # Outputs the message if fail_credits is not in given list
                    print() #To print a blank line
            else:
                print("The credits you entered are 'Out of Range'")      # Outputs the message if defer_credits is not in given list
                print()  #To print a blank line
        else: 
            print("The credits you entered are 'Out of Range'")          # Outputs the message if pass_credits is not in given list
            print()     #To print a blank line
    except ValueError:                               
